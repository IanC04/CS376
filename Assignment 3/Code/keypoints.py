...
def getAllKeypoints() -> (np.ndarray, np.ndarray):
    two_d = np.array([[1971, 1377], [1441, 1558], [1706, 1559], [1971, 1555], [2236, 1553], [2499, 1553],
                      [1149, 1762], [2765, 1742], [1504, 2112], [1824, 1685], [2234, 1554], [1975, 2750], [1971, 1866],
    ...
    three_d = np.array([[6, 6, 0], [5, 1, 0], [4, 2, 0], [3, 3, 0], [2, 4, 0], [1, 5, 0],
                        [6, 0, 1], [0, 6, 1], [3, 0, 2], [2, 1, 0], [1, 4, 0], [0, 0, 4], [0, 0, 0], [1, 0, 0],
                        [1, 1, 0],
