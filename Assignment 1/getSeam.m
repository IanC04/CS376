function output = getSeam(cumulativeEnergyMatrix, seamDirection)
...
for j=size(horizontalSeam)-1:-1:1
    [~, bb]=min(cumulativeEnergyMatrix(b-1:b+1,j));
    b=b+bb-2;
    horizontalSeam(j)=b;
end
