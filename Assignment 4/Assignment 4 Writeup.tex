...
\begin{document}
    ...
    \begin{itemize}
        ...
        For Adaptive Boosting classifier, the accuracy is about 12\%. This is because it's very
        biased towards the third label, the cat. The training time is very long, but optimizaed
        with multi-processing on multiple cores, but the testing time is very fast.
