...
\begin{document}
    ...
    \begin{itemize}
        ...
        The results are interesting, since noise is suppressed by a larger bin size, but in the planets picture, the
        \"shadow of Jupiter\" is determined a circle, showing the the half circle generated by the shadow was detected
        .\newline
        ...
        produces.}\newline
        I plotted both the best fitting circle with respect to number of inliers and the total inliers of circles
        detected. The detected circles were also shown in the figure.\newline
