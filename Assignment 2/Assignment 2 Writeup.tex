...
\begin{document}
    ...
    \begin{itemize}
        ...
        I found the maximum value of the accumulator array and determined that it was the center of the circle,
        unless there are more than 180 points having this point as its center, in which case there are multiple
        circles.\newline
